...
public abstract class TestBase {
    ...
    public void tearDown() {
      ...
      // driver.quit();
           ...
           //    MULTIPLE WINDOW :
          // 1 parametre alır :Geçiş yapmak istedigim title
          // ORNEK:  driver.get("https://the-internet.herokuapp.com/windows ");
          //         switchToWindow("New Window");
          //          switchToWindow("The Internet"); / gecmek ısdedımızde
...
//===============Explicit Wait==============//
    ...
    //    This can be used when a new page opens.yenı sayfaya gecıserde kullanılabılır
...
//    Bu method ile sayfanin en altina inebiliriz
    ...
    //   gitmis oldugum metni elemente yazdirir -- deger girmek istedimiz metin icin kullanırız
