...
public class C01_WindowHandle2 extends TestBase {
    ...
    public void windowHandle2() {
        ...
        //IKINCI PENCERE ACILIR VE IKINCI PENCEREDE ISLLEM YAPMAK ISTEDIGIMIZDEN , O PENCEREYE SWITCH-GECIS-YAPMALIYIZ
        switchToWindow(1);//2. windowa gecis yaptık. driver artık 2. windowda
