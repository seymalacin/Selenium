...
public class C01_FileUpload extends TestBase {
    ...
    public void fileUploadTest() {
        ...
        //chooseFile butonuna basalim
         WebElement chooseFilleButton = driver.findElement(By.id("file-upload"));

        //Yuklemek istediginiz dosyayi secelim.
         String dosyaYolu = System.getProperty("user.home")+"\\OneDrive\\Masaüstü\\logo.jpeg";

         //chooseFilleButton una yuklemek ısdedımız dosyanın path ini gondererek dosyayı secdım

        chooseFilleButton.sendKeys(dosyaYolu);
        waitFor(5);
